...
if(player.x + canvas.width > lastPlatformX - 500){
generatePlatform()
}
...
ctx.fillRect(px+25,py+5,5,5)

ctx.fillStyle="brown"

if(player.type=="boy"){
ctx.fillRect(px+5,py-5,30,10)
}else{
ctx.fillRect(px,py-5,40,15)
ctx.fillRect(px-5,py+5,10,25)
ctx.fillRect(px+35,py+5,10,25)
}

ctx.fillStyle="#ffe0bd"
ctx.fillRect(px-5,py+25,10,10)
ctx.fillRect(px+35,py+25,10,10)
